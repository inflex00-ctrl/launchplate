/* ==========================================================================
   BRIGHTWATER DENTAL — SITE CONFIGURATION
   --------------------------------------------------------------------------
...
window.SITE_CONFIG = {
   ...
   * ------------------------------------------------------------------ */
  business: {
    name:    "",           /* e.g. "Brightwater Dental" */
    email:   "",           /* e.g. "hello@brightwaterdental.ie" — where enquiries go */
    phone:   "",           /* e.g. "+353 1 555 0142" */
    address: "",           /* e.g. "14 Marlowe Quay" */
   ...
   *    embed appears on the appointments page. The kit's own
   *    appointment request form stays exactly where it is as the fallback — set
  ...
  demo: {
    ...
    email:    "hello@brightwaterdental.ie",
    phone:    "+353 1 555 0142",
    address:  "14 Marlowe Quay",
