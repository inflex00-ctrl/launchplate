...
window.SITE_CONFIG = {
  ...
  business: {
    name:    "",           /* e.g. "Lumen" */
    email:   "",           /* e.g. "hello@lumen.example.com" — where enquiries go */
    phone:   "",           /* e.g. "+31 20 123 4567" */
   ...
   * 4. WAITLIST
   *
   *    The waitlist confirmation can show the signup's queue position.
   *    A static site cannot actually know that number, so the card is
   *    hidden unless you put a starting count here — better an honest
   *    gap than a made-up figure shown to a real person.
   * ------------------------------------------------------------------ */
  waitlist: {
    baseCount: ""          /* e.g. 2848 */
  },
