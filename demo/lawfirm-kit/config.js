/* ==========================================================================
   HALLOWAY & FINCH LLP — SITE CONFIGURATION
   --------------------------------------------------------------------------
...
window.SITE_CONFIG = {
   ...
   * ------------------------------------------------------------------ */
  business: {
    name:    "",           /* e.g. "Halloway & Finch LLP" */
    email:   "",           /* e.g. "inquiries@hallowayfinch.example" — where enquiries go */
    phone:   "",           /* e.g. "(617) 555-0142" */
    address: "",           /* e.g. "128 Ashcroft Street, Suite 1900" */
